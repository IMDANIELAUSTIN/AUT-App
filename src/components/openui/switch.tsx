  ...
  ({ checked = false, onCheckedChange, className, disabled, ...props }, ref) => (
    ...
    >
      <span
        data-state={checked ? "checked" : "unchecked"}
        className={cn(
          "openui-switch-item-thumb pointer-events-none block h-4 w-4 rounded-full bg-background shadow-lg ring-0 transition-transform",
...
Switch.displayName = "OpenUISwitchAdapter";
